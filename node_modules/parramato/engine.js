    ...
    return new Promise(async function (resolve, reject) {
        try {
            if(data.type=="pre"){
                ...
                if(modelData.tags.userSays == 'cancel' || modelData.tags.userSays == '#'){
                   modelData.tags = {
                    userSays : 'cancel'
                   }
                }
                if(modelData.intent == 'start'){
                    modelData.tags.userSays = 'multipleUsers'
                }
...
module.exports.decorator = (data, dbData) => {
    return new Promise(async function (resolve, reject) {
        ...
        // console.log(data.next.pre[0].url.trim() + "data.next.pre[0].url")
        const requestDecorator = {
            method: data.next.pre[0].requestType,
            url: data.next.pre[0].url.trim(),
            json: {
                data: data,
                reply:data,
                tags: tags,
...
module.exports.validator = (data, dbData) => {
    return new Promise(async function (resolve, reject) {
        ...
        const requestValidator = {
            ...
            url: data.stage.next.post[0].url.trim(),
            json: {
                data: data.data,
                stage: data.stage.stage,
                tags: tags,
        ...
        console.log(JSON.stringify(requestValidator))
