...
function switchOnListeners(app, verificationToken, pageAccessToken, path) {
    ...
    fbListener.on("validated|fb", (response) => {
     // // console.log("Validated webhook " + response.status) 
 })
    fbListener.on("incoming|fb", (response) => { 
    // // console.log("Incoming message") 
})
    fbListener.on("read|fb", (response) => { 
    // // console.log("Read") 
})
    fbListener.on("delivered|fb", (response) => { 
    ...
    function prepareAndSendTextAndElements(response, callback) {
        ...
        response.text = response.text.toString()
        // // // console.log(response.text)
        // // // console.log(typeof(response.text))
        response.text = replaceall("|br|", "\n", response.text)
        // response.text = replaceall("|break|", "\n", response.text)
        response.text = replaceall("<br>", "\n", response.text)
        response.text = replaceall("<break>", "\n", response.text)
        response.text = replaceall("<b>", "*", response.text)
        response.text = replaceall("</b>", "*", response.text)
        response.text = replaceall('<a href="tel:1-800-258-0001">1-800-258-0001</a>', '1-800-258-0001', response.text)
        
        // // // console.log("DATA="+response.text)
        // // // console.log("Response Type....."),
        // // // console.log(response.type)
        // // // console.log("enddddddddddddddddddddddaxxaxaxdddddd")
        // // // console.log("Response Text.....", response.text, "enddddddddddddddddddddddaxxaxaxdddddd")
        // extract media
        ...
        if (response.text.includes("\\n")) {
            // // // console.log(response.text)
            // // // console.log("0000000000000000000000000000000000050")
