module.exports={
    q2: model => {
        ...
        else if (model.tags.answer1 == false) {
            model.reply = {
                type: "quickReply",
    ...
    q3: model => {
        ...
        else if (model.tags.answer2 == false) {
            model.reply = {
                type: "quickReply",
    ...
    q4: model => {
        ...
        else if (model.tags.answer3 == false) {
            model.reply = {
                type: "quickReply",
