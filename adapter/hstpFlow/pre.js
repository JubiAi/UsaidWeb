    ...
    return new Promise(function(resolve) {
      ...
      if (model.tags.answer1 == false) {
        ...
        model.reply = {
          type: "quickReply",
          text:
            "Nice try, but the correct answer is 4 weeks. |break|Looks like you need to learn more about HTSP",
          next: {
            data: [
              {
                data: "HTSP",
        ...
        model.reply = {
          type: "quickReply",
          text:
            "Correct! A woman becomes fertile as early as 4 weeks post-pregnancy. |break|You will learn this and more under  HTSP!",
          next: {
            data: [
              {
                data: "HTSP",
  ...
  hstphow: model => {
    return new Promise(function(resolve) {
      ...
      model.reply = {
        type: "quickReply",
        text:
          "Healthy Timing and Spacing of Pregnancy (HTSP) is all about the safety and health of the mother and the child.",
        next: {
          data: [
            {
              data: "how so",
  ...
  mother: model => {
    return new Promise(function(resolve) {
      ...
      model.reply = {
        type: "quickReply",
        text:
          "Yes! This time helps the mother to rest and regain her health while the first child gets all the love and attention he/she requires from mummy. ❤️ |break|${image::" +
