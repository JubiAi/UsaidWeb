...
(function() {
  ...
  window.templateOpenView =
    ...
    '<section class="artMenu"><section class="secMenucontent-widget" id="secMenucontent-widget" style="display: block;"><section class="sec_dropdown"><div class="closeBtn"><img src="https://khushi.jubi.ai/images/close_icon.png"></div><h3>Menu</h3><ul><li class="jubi-menu-val" onclick="window.askBot('/Start /')"><p>Start Over</p></li><li class="jubi-menu-val" onclick="window.askBot/('/Main menu/')"><p>Main menu</p></li><li class="jubi-menu-val"><p><a href="http://www.buymecondom.com/" target="_blank">Buy Condom</a></p></li><li class="jubi-menu-val" onclick="window.askBot('/Speak to a counsellor/')"><p>Speak to a counsellor</p></li><li class="jubi-menu-val" onclick="window.askBot('/Cancel Conversation/')"><p>Cancel Conversation</p></li></ul></section><div class="trianglearrow"><img src="https://khushi.jubi.ai/images/triangledown.png" class="img-responsive"></div></section><div class="iconMenu"><img src="https://khushi.jubi.ai/images/menu.png"></div></section>' +
