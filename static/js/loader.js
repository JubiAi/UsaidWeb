...
(function() {
  ...
  window.templateOpenView =
    ...
    "<p>Cancel</p>" +
    "</li>" +
    '<li class="jubi-menu-val" onclick="window.askBot(\'talk To Counsellor\')">' +
    ...
    '<div class="sendIcon" id="button-send" style="display: block;">' +
    '<button id="jubi-bottomClick" type="submit" onclick="clickSendButton();return false;" style="">' +
    '<img src="./images/send.png" id="jubi-graySend" class="img-responsive">' +
    '</button><div class="voiceIcon button-play-ws-right" id="button-play-ws" style="display: none;">' +
    '<img src="./images/voice.png" class="img-fluid">' +
    "</div>" +
    '<div class="voice-buttons" id="voice-buttons" style="display:block;">' +
    '<div class="voicePulse" id="button-stop-ws" style="display: none;">' +
    '<div class="sk-three-bounce">' +
    ...
    '<img src="https://parramato.com/bot-view/JubiMoney_788585788275/dev/images/attachment.png" class="img-responsive" style="">' +
